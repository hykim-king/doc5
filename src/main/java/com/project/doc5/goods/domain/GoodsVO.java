...
public class GoodsVO {
	...
	public GoodsVO(int goodsNo, String goodsName, String goodsEngName, double goodsPrice, String hotFl, double hotPrice,
			...
			String modDt, String modId, String options, int goodsCnt, String userId, String orderType,
			List<OptionTypeVO> optionTypeVO, List<CategoryJoinVO> categoryJoinVO, List<GoodsInfoVO> goodsInfoVO) {
		super();
	...
	public String toString() {
		return "GoodsVO [goodsNo=" + goodsNo + ", goodsName=" + goodsName + ", goodsEngName=" + goodsEngName
				...
				+ regId + ", modDt=" + modDt + ", modId=" + modId + ", options=" + options + ", goodsCnt=" + goodsCnt
				+ ", userId=" + userId + ", orderType=" + orderType + ", optionTypeVO=" + optionTypeVO
